    ...
    <ProtectedRoute>
      ...
      <main className="relative min-h-screen overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-black text-white">
        ...
        <section className="relative mx-auto max-w-7xl px-6 py-16">
          ...
          <p className="mb-3 text-sm font-semibold uppercase tracking-wider text-yellow-400">My Favorites</p>
          <h1 className="mb-6 text-4xl font-bold md:text-5xl">Favorite Recipes</h1>

          {recipes.length === 0 ? (
            <div className="rounded-xl border border-gray-700 bg-slate-900/70 p-8 text-center text-gray-300">
              You have not marked any recipe as favorite yet.
            </div>
          ) : (
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center justify-between gap-2">
                      ...
                      <div className="flex gap-2">
                        <Link
                          href={`/recipes/${recipe.id}?from=favorites`}
